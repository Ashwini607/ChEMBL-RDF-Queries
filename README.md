...
5. Retrieve activities of proteins involved in Alzheimer disease (Runs on ChEMBL SPARQL endpoint). [file](https://github.com/Ashwini607/ChEMBL-RDF-Queries/blob/master/federatedAndOthersEndpointQueries/actDiseaseChUp.rq) or [see it live](http://tinyurl.com/on6dwv3) 
